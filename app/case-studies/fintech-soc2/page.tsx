        ...
        <div className="container px-4 md:px-6 relative z-10">
          <div className="max-w-3xl">
            ...
            <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl text-white mb-6">
              FinTech Startup Achieves SOC 2 Compliance in Just 8 Weeks
            </h1>
            <p className="text-xl text-white/90 mb-8">
              How we helped a rapidly growing fintech company achieve SOC 2 Type I compliance quickly to close
              enterprise deals worth over $1.2M in annual recurring revenue.
            </p>
          </div>
        </div>
      </section>
